      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="col-span-2 rounded-2xl border border-border bg-card shadow-sm p-6 min-h-[400px] flex items-center justify-center relative overflow-hidden group">
            ...
            <div className="text-center relative z-10">
                <SettingsIcon className="h-16 w-16 text-muted-foreground/30 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-foreground">Interactive Settings Visualization</h3>
