...
export const Route = createFileRoute("/drone-monitoring")({
  component: DroneMonitoring,
});
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-3 border-b border-border pb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Drone Monitoring</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="col-span-2 rounded-2xl border border-border bg-card shadow-sm p-6 min-h-[400px] flex items-center justify-center relative overflow-hidden group">
            ...
            <div className="text-center relative z-10">
                ...
                <h3 className="text-lg font-semibold text-foreground">Interactive Drone Monitoring Visualization</h3>
